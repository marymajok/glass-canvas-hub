...
import { Target, Sparkles, Heart, Shield, Award, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="glass-card p-8 md:p-12 text-center bg-gradient-to-r from-primary/10 to-accent/10">
